...
export function WhatsappProductButton({
  ...
  const message = productMessage({ storeName, productName, price, url });
  ...
  return (
    <a
      ...
      className="inline-flex items-center justify-center gap-2 rounded-lg border-2 border-[#25D366] px-5 py-3 font-semibold text-[#128C7E] transition hover:bg-emerald-50"
    >
